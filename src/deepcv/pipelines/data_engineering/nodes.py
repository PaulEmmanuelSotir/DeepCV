...
def preprocess_iris(data: pd.DataFrame, example_test_data_ratio: float) -> Dict[str, Any]:
    ...
    return {'train_x': train_data_x, 'train_y': train_data_y, 'test_x': test_data_x, 'test_y': test_data_y}
