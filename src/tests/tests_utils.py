...
if __name__ == '__main__':
    cli = test_module_cli(__file__) # Allows you to run pytest only on a given python source file (returns a click command which takes eventual pytest arguments)
    cli()
```
